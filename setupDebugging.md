...
## Attempt 5: Plain JS shim as bin entry (SUPERSEDED — see `.claude/rules/packaging-and-bins.md`)
...
> its rationale live in **`.claude/rules/packaging-and-bins.md` → "No bin shims — every `bin` lives in
> `publishConfig.bin`"**; this
