...
export class CompanyHeaders {
     ...
     */
    static readonly TENANT_ID = ContextKey.untrusted<string>('tenantId', 'x-tenant-id');

    /**
     * API version for this request. Allows gradual API migration and
     * version-specific behavior.
     */
    static readonly API_VERSION = ContextKey.untrusted<string>('apiVersion', 'x-api-version');
