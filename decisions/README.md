...
| 0004 | [pr-artifacts-are-machine-global.md](0004-pr-artifacts-are-machine-global.md) | An artifact belongs to the scope of the fact it describes — the gated PR merge body is keyed by the PR, not by the tree that rendered it | taken + implemented |
