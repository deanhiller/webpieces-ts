...
| # | doc | axis | status |
|---|---|---|---|
| 0001 | [tree-identity-and-governance.md](0001-tree-identity-and-governance.md) | Which tree governs a tool call — and which release, which state dir, which log file follow from that | D2, D5 taken; **D1 REVERSED (2026-08-07) — state stays in `{repo}/.webpieces`, so D4/D6 are moot with it**; D7 withdrawn |
