 ...
 * `@WpAuthSharedSecret(key)` name. Bound once (from config; tests pass literals) and used by every
...
export class Secrets {
    ...
    /** The secret this client sends for the given `@WpAuthSharedSecret(key)`, or undefined if unset. */
