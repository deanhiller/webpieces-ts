...
describe('toError - Error instances', () => {
...
describe('toError - Error-like objects', () => {
...
describe('toError - Objects without message', () => {
...
describe('toError - Primitive values', () => {
...
describe('toError - Real-world scenarios', () => {
