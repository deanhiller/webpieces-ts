// shouldSkipRule / SkipRuleResult moved to @webpieces/rules-config
...
export { shouldSkipRule } from '@webpieces/rules-config';
export { SkipRuleResult } from '@webpieces/rules-config';
