...
// commands (wp-start-update, wp-finish-update, wp-finish-upsert-pr, wp-human-post-pr, wp-start-upsert-pr).
...
export {
    ...
    PrCommentRequest,
    PrCommentResult,
} from './scripts/workflow/pr-comment-upserter';
