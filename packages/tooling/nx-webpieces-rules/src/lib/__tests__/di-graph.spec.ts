...
`,
        ...
        it('records toDynamicValue bindings as dynamic leaves', () => {
    ...
    describe('multiInject and unresolved handling', () => {
        let fixture: Fixture;
        let graph: DiGraph;
...
`,
    ...
    describe('library project (no controllers) and cycles', () => {
        let fixture: Fixture;
        let graph: DiGraph;
