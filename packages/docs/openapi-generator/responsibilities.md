...
`apps/app-example/partner-api` is the worked example: a real contract, its manifest, and the committed documents, with a spec that regenerates and diffs them.
