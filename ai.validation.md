...
| **validate-no-implicit-any** | Validates parameters/variables/properties don't infer to `any` via TS compiler (TS7006/7005/7018/etc), git-based modes: OFF / MODIFIED_CODE / NEW_AND_MODIFIED_FILES. Escape hatch: `// webpieces-disable no-implicit-any -- reason`. Pairs with `validate-no-any-unknown` (keyword ban) — together they force real types. | ✅ WIRED |
